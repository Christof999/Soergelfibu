                ...
                {filtered.map(doc => {
                  ...
                  return (
                    <tr key={doc.id} className="hover:bg-gray-50 transition-colors">
                      <td className="px-5 py-3 font-mono text-xs text-gray-700 font-medium">{doc.nummer}</td>
                      <td className="px-5 py-3 text-gray-800">{kunde?.firma || '–'}</td>
                      <td className="px-5 py-3 text-gray-500 max-w-xs truncate">{doc.betreff || '–'}</td>
